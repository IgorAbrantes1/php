<nav class="modules">
    ...
    <div class="module azul">
        ...
        <ul>
            <li>
                <a href="exercicio.php?dir=api&file=datas_01">Data #01</a>
            </li>
            <li>
                <a href="exercicio.php?dir=api&file=datas_02">Data #02</a>
            </li>
            <li>
    ...
    <div class="module verde">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=tratamento_erro&file=desafio_intdiv_teste">Desafio intfiv</a>
            </li>
            <li>
    ...
    <div class="module roxo-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=includes&file=desafio">Desafio</a>
            </li>
        </ul>
    </div>
